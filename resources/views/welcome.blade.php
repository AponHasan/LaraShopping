            ...
            <div class="panel-group">
              <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <button  data-toggle="modal" data-target="#product_detail_modal" class="btn-sm">Product Info <i class="fa fa-info-circle"></i></button>
                    </div>
                    <div  class="title-product" style="font-size: 15px"> <h4 style="font-size: 15px;">Gammie Plain Cold Shoulder Blouse</h4></div>
                    <div class="size"> 
            ...
            <div class="panel-group">
              <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="title-product"> <h4 style="font-size: 15px;">Gammie Plain Cold Shoulder Blouse</h4></div>
                    <div class="size"> 
                    <span class="fa fa-star star_color"></span>
                    <span class="fa fa-star star_color"></span>
                    <span class="fa fa-star star_color"></span>
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
            ...
            <div class="col-md-5">
               ...
               <p style="font-size: 13px">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
